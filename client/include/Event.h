...
public:
    Event(string name, string team_a_name, string team_b_name, int time, map<string, string> game_updates,
          map<string, string> team_a_updates, map<string, string> team_b_updates, string discription);
